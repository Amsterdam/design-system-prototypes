...
export const ParkeervergunningVoorSportverenigingenPage = () => (
  <>
    <Grid paddingBottom="medium">
        ...
        <Accordion className="amsterdam-mb--md" headingLevel={4}>
          ...
          <Accordion.Section label="Zuid">
            <UnorderedList>
              ...
              <UnorderedList.Item>
                U kunt de parkeervergunning in Zuid 1, 2 en 3 <strong>niet</strong> met wisselend kenteken aanvragen.
              </UnorderedList.Item>
            </UnorderedList>
          </Accordion.Section>
        </Accordion>
      ...
      >
        ...
        <Paragraph>
          ...
          laten ingaan op 1 oktober. U betaalt dan 3 maanden: van oktober tot en met december. U kunt de vergunning ook
          op 20 september laten ingaan. U betaalt dan wel de hele maand september. Vanaf 1 januari betaalt u dan per 6
          maanden.
        </Paragraph>
      </Grid.Cell>
      <Grid.Cell
        ...
        <Accordion headingLevel={4}>
          <Accordion.Section label="Lees de voorwaarden">
            <UnorderedList>
              ...
              <UnorderedList.Item>
                Hoort er een parkeerplaats bij uw sportvereniging? Het aantal eigen parkeerplaatsen trekken wij af van
                het totale aantal vergunningen dat u kunt krijgen. De uitkomst kan ook 0 zijn. U krijgt dan geen
                parkeervergunning.
              </UnorderedList.Item>
            </UnorderedList>
          </Accordion.Section>
